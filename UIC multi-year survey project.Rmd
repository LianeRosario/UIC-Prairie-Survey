...
## test bind of calculations
```{r}
test_bind <- bind_rows(tibble(x = mean_wt_c_1979), tibble(y = species_frequency_1979))
...
##### Here the new 1979 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv}
write_csv(survey_1979, file = "data/jwp_survey_1979.csv")

write_csv(mean_wt_c_1979, file = "data/mean_wt_c_1979.csv")

write_csv(species_frequency_1979, file = "data/species_frequency_1979.csv")

write_csv(total_cover_1979, file = "data/total_cover_1979.csv")

write_csv(total_richness_1979, file = "data/total_richness_1979.csv")
```
...
##### Here the new 1980 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv-1980}
write_csv(survey_1980, file = "data/jwp_survey_1980.csv")

write_csv(mean_wt_c_1980, file = "data/mean_wt_c_1980.csv")

write_csv(species_frequency_1980, file = "data/species_frequency_1980.csv")

write_csv(total_cover_1980, file = "data/total_cover_1980.csv")

write_csv(total_richness_1980, file = "data/total_richness_1980.csv")
```
...
##### Here the new 1981 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv-1981}
write_csv(survey_1981, file = "data/jwp_survey_1981.csv")

write_csv(mean_wt_c_1981, file = "data/mean_wt_c_1981.csv")

write_csv(species_frequency_1981, file = "data/species_frequency_1981.csv")

write_csv(total_cover_1981, file = "data/total_cover_1981.csv")

write_csv(total_richness_1981, file = "data/total_richness_1981.csv")
```
...
##### Here the new 1982 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv-1982}
write_csv(survey_1982, file = "data/jwp_survey_1982.csv")

write_csv(mean_wt_c_1982, file = "data/mean_wt_c_1982.csv")

write_csv(species_frequency_1982, file = "data/species_frequency_1982.csv")

write_csv(total_cover_1982, file = "data/total_cover_1982.csv")

write_csv(total_richness_1982, file = "data/total_richness_1982.csv")
```
...
##### Here the new 1984 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv-1984}
write_csv(survey_1984, file = "data/jwp_survey_1984.csv")

write_csv(mean_wt_c_1984, file = "data/mean_wt_c_1984.csv")

write_csv(species_frequency_1984, file = "data/species_frequency_1984.csv")

write_csv(total_cover_1984, file = "data/total_cover_1984.csv")

write_csv(total_richness_1984, file = "data/total_richness_1984.csv")
```
...
##### Here the new 1987 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv-1987}
write_csv(survey_1987, file = "data/jwp_survey_1987.csv")

write_csv(mean_wt_c_1987, file = "data/mean_wt_c_1987.csv")

write_csv(species_frequency_1987, file = "data/species_frequency_1987.csv")

write_csv(total_cover_1987, file = "data/total_cover_1987.csv")

write_csv(total_richness_1987, file = "data/total_richness_1987.csv")
```
...
##### Here the new 1995 survey and analysis tables created are written back into an csv file that can be downloaded.

```{r write-survey-csv-1995}
write_csv(survey_1995, file = "data/jwp_survey_1995.csv")

write_csv(mean_wt_c_1995, file = "data/mean_wt_c_1995.csv")

write_csv(species_frequency_1995, file = "data/species_frequency_1995.csv")

write_csv(total_cover_1995, file = "data/total_cover_1995.csv")

write_csv(total_richness_1995, file = "data/total_richness_1995.csv")
```
...
```{r bind-surveys}
jwp_multi_year_survey <- bind_rows(survey_1979, survey_1980, survey_1981, survey_1982, survey_1984, survey_1987, survey_1995)

view(jwp_multi_year_survey)
```
