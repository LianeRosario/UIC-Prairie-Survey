...
## Changes in richness for each plot between the years 1979 and 2020
...
## Change in the mean c-value for each plot between the years 1979 and 2020
...
species_freq_variations <- jwp_species_frequency %>%
...
```{r plot-most-frequent-nonnatives}
nonnative_top_frequent <- jwp_species_frequency %>%
  filter(native == 0, fraction > 0.1)

ggplot(nonnative_top_frequent, aes(x = year)) +
  geom_bar(aes(fill = species)) +
  labs(title="Top 6 Most Frequent Non-Native Species",
        x ="Year", y = "Number of Appearances") +
  theme_minimal()
```

```{r plot-most-frequent-natives}
native_top_frequent <- jwp_species_frequency %>%
  filter(native == 1, fraction > 0.4, species != "sp.")

ggplot(native_top_frequent, aes(x = year)) +
  geom_bar(aes(fill = species)) +
  labs(title="Top 10 Most Frequent Native Species",
        x ="Year", y = "Number of Appearances") +
  theme_minimal()
```
