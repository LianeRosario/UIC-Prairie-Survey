...
#### Fixing a c value for a species that was left out of the Usace data
```{r assign-c-value}
survey_2020 <- survey_2020 %>%
  filter(species == "eleocharis erythropoda") %>%
  replace_na(list(c_value = 1))
```
...
```{r bind-variables}
jwp_variables <- bind_rows(variables_1979, variables_1980, variables_1981, variables_1982, variables_1984, variables_1987, variables_1995)
